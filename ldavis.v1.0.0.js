...
var tabTopic={};
 ...
 for(var key in tabSave)
            { 
                
                tabName[key]=tabSave[key];
 
            }
for(var key in tabF)
            { 
                
                tabFusion[key]=tabF[key];
...
var LDAvis = function(to_select, data_or_file_name) {
 ...
 for(var key in tabFusion){
                ...
                removeCircle(document.getElementById(topicID + tabFusion[key]));
                removeCircle(document.getElementById(topicID + tabFusion[key]));
...
function tailleTab(tab){

    var taille=0;
    for (var o in tab) ++taille;
    return taille;
...
var str="var tabSave={";
var compt=0;
var tailleName = tailleTab(tabName);
var tailleFusion = tailleTab(tabFusion);
    for(var key in tabName)
    {   if((compt<(tailleName-1)) && (tailleName>1)){
            str=str+" "+key+":"+"'"+tabName[key]+"',";
        }
        else if (tailleName==1){
            str=str+key+":"+"'"+tabName[key]+"'";
        }
        else{
            str=str+" "+key+":"+"'"+tabName[key]+"'";
    ...
    for(var key in tabFusion)
    { 
        if(compt<(tailleFusion-1) && (tailleFusion>1)){
                    str=str+" "+key+":"+tabFusion[key]+',';
                }
                else if (tailleFusion==1){
                    str=str+key+":"+tabFusion[key];
                }
                else{
                    str=str+" "+key+":"+tabFusion[key];
